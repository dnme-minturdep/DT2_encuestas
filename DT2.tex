...
\begin{figure}
\includegraphics[width=17.24in]{imagenes/Tabla 1} \caption{ Padrón de establecimientos de la localidad Y}\label{fig:padronY}
\end{figure}
...
\begin{figure}
\includegraphics[width=21.83in]{imagenes/Figura 1} \caption{ Estratos de establecimientos de la localidad Y}\label{fig:localidadY}
\end{figure}
...
\includegraphics[width=29.21in]{imagenes/Tabla 2}

\caption{ Criterios de estratificación y definición de los estratos}

(\#fig:criterios\_estratos)
...
\begin{figure}
\includegraphics[width=12.82in]{imagenes/Tabla 2A} \end{figure}

\begin{figure}
\includegraphics[width=16.15in]{imagenes/Tabla 2B} \end{figure}
...
\begin{figure}
\includegraphics[width=13.06in]{imagenes/Tabla 2C} \end{figure}
...
\textbackslash begin\{figure\}
\includegraphics[width=22.15in]{imagenes/Tabla 3}

\caption{Selección de las muestras al interior de cada estrato}

(\#fig:muestra\_interior)
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}
\includegraphics[width=17.24in]{imagenes/Tabla 4}

\caption{Muestra final de establecimientos}
...
\textbackslash begin\{figure\}
\includegraphics[width=20.81in]{imagenes/Figura 2}

\caption{Lugar de residencia habitual}

(\#fig:residencia\_habitual)
\textbackslash end\{figure\}

\begin{figure}
\includegraphics[width=32.1in]{imagenes/Figura 2.1} \caption{Lugar de residencia habitual. Residentes de Argentina}\label{fig:residentes}
\end{figure}

\hfill\break

\textbackslash begin\{figure\}
\includegraphics[width=21.64in]{imagenes/Figura 2.2}

\caption{Lugar de residencia habitual. No residentes de Argentina}

(\#fig:no\_residentes)
\textbackslash end\{figure\}

\textbackslash begin\{figure\}
\includegraphics[width=11.19in]{imagenes/Figura 2.2.1}

\caption{Lugar de residencia habitual. No residentes de Argentina. América}

(\#fig:america\_latina)
\textbackslash end\{figure\}

\begin{figure}
\includegraphics[width=10.92in]{imagenes/Figura 2.2.2} \caption{Lugar de residencia habitual. No residentes de Argentina. Europa}\label{fig:europa}
\end{figure}
...
\begin{figure}
\includegraphics[width=18.67in]{imagenes/Tabla 5} \caption{Categorías ocupacionales utilizadas en la EOH (MINTURDEP-INDEC)}\label{fig:ocupados}
\end{figure}
...
\textbackslash begin\{figure\}
\includegraphics[width=16.93in]{imagenes/Figura 3}

\caption{Tipos de alojamientos turísticos}

(\#fig:tipos\_alojamientos)
\textbackslash end\{figure\}

\textbackslash begin\{figure\}
\includegraphics[width=10.92in]{imagenes/Figura 3.1}

\caption{Tipos de alojamientos turísticos. Establecimientos hoteleros}

(\#fig:establecimientos\_hoteleros)
\textbackslash end\{figure\}

\textbackslash begin\{figure\}
\includegraphics[width=10.92in]{imagenes/Figura 3.2}

\caption{Tipos de alojamientos turísticos. Establecimientos para-hoteleros}

(\#fig:establecimientos\_para\_hoteleros)
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}
\includegraphics[width=11.99in]{imagenes/Tabla 5A}
...
\begin{figure}
\includegraphics[width=28.93in]{imagenes/Tabla 6} \caption{Ventajas, limitaciones y requerimientos por forma de relevamiento}\label{fig:relevamiento}
\end{figure}
...
\textbackslash begin\{figure\}
\includegraphics[width=29.08in]{imagenes/Tabla 6A}

\caption{Modelo de planilla para la carga de los datos}
...
\textbackslash begin\{figure\}
\includegraphics[width=18.47in]{imagenes/Tabla 7 A}

\caption{Muestra final}
...
\begin{figure}
\includegraphics[width=23.62in]{imagenes/tabla 7B} \end{figure}
...
\begin{figure}
\includegraphics[width=23.54in]{imagenes/Tabla 8} \caption{Indicadores, información necesaria para su construcción y procedimiento de estimación}\label{fig:indicadores}
\end{figure}
...
\textbackslash begin\{figure\}
\includegraphics[width=26.93in]{imagenes/Hoteles 1 y 2 estrellas, menos de 200 plazas}

\caption{IHoteles 1 y 2 estrellas, menos de 200 plazas}

(\#fig:1\_2\_estrellas)
\textbackslash end\{figure\}

\textbackslash begin\{figure\}
\includegraphics[width=26.93in]{imagenes/Hoteles 3 estrellas,  Apart hotel y Boutique, menos de 200 plazas}

\caption{Hoteles 3 estrellas,  Apart hotel y Boutique, menos de 200 plazas}

(\#fig:3\_estrellas)
\textbackslash end\{figure\}

\textbackslash begin\{figure\}
\includegraphics[width=28in]{imagenes/Hoteles 3 estrellas,  Apart hotel y Boutique, mas de 200 plazas}

\caption{Hoteles 3 estrellas,  Apart hotel y Boutique, más de 200 plazas}

(\#fig:3\_estrellas\_mas\_200)
\textbackslash end\{figure\}

\textbackslash begin\{figure\}
\includegraphics[width=28in]{imagenes/Hoteles 4 y 5 estrellas, menos de 200 plazas}

\caption{Hoteles 4 y 5 estrellas, menos de 200 plazas}

(\#fig:4\_5\_estrellas\_menos\_200)
\textbackslash end\{figure\}

\textbackslash begin\{figure\}
\includegraphics[width=28in]{imagenes/Hoteles 4 y 5 estrellas, mas de 200 plazas}

\caption{Hoteles 4 y 5 estrellas, más de 200 plazas}

(\#fig:4\_5\_estrellas\_mas\_200)
\textbackslash end\{figure\}

\textbackslash begin\{figure\}
\includegraphics[width=27.76in]{imagenes/Establecimientos parahoteleros}

\caption{Establecimientos parahoteleros}
...
\textbackslash begin\{figure\}
\includegraphics[width=21.5in]{imagenes/figuras-parte123-01}

\caption{.}

(\#fig:total\_localodad\_y)
\textbackslash end\{figure\}
