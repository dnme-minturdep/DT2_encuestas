...
```{r criterios-estratos, echo=FALSE, fig.cap=" Criterios de estratificación y definición de los estratos" }
...
```{r cantidad-de-plazas, echo=FALSE, fig.cap="Cantidad de plazas" }
knitr::include_graphics('imagenes/tabla_2A.jpg')
```

```{r peso-de-estrato, echo=FALSE, fig.cap="Peso de estrato" }
...
```{r casos-a-realizar, echo=FALSE, fig.cap="Casos a realizar" }
...
```{r muestra-interior, echo=FALSE, fig.cap="Selección de las muestras al interior de cada estrato" }
...
```{r muestra-final, echo=FALSE, fig.cap="Muestra final de establecimientos" }
...
```{r residencia-habitual, echo=FALSE, fig.cap="Lugar de residencia habitual" }
...
```{r no-residentes, echo=FALSE, fig.cap="Lugar de residencia habitual. No residentes de Argentina" }
knitr::include_graphics('imagenes/figura_2_2.jpg')
```

```{r america-latina, echo=FALSE, fig.cap="Lugar de residencia habitual. No residentes de Argentina. América" }
...
```{r tipos-alojamientos, echo=FALSE, fig.cap="Tipos de alojamientos turísticos" }
knitr::include_graphics('imagenes/figura_3.jpg')
```

```{r establecimientos-hoteleros, echo=FALSE, fig.cap="Tipos de alojamientos turísticos. Establecimientos hoteleros" }
knitr::include_graphics('imagenes/figura_3_1.jpg')
```

```{r establecimientos-para-hoteleros, echo=FALSE, fig.cap="Tipos de alojamientos turísticos. Establecimientos para-hoteleros" }
...
```{r grupo-a-b, echo=FALSE, fig.cap="Tabla de Grupos" }
...
```{r tabla-6a, echo=FALSE, fig.cap="Modelo de planilla para la carga de los datos" }
...
```{r tabla-7a, echo=FALSE, fig.cap="Muestra final" }
...
```{r tabla7A, echo=FALSE, fig.cap="Ponderadores" }
...
```{r 1-2-estrellas, echo=FALSE, fig.cap="Hoteles 1 y 2 estrellas, menos de 200 plazas" }
knitr::include_graphics('imagenes/hoteles1y2_estrellas_menos_de_200_plazas.jpg')
```

```{r 3-estrellas, echo=FALSE, fig.cap="Hoteles 3 estrellas,  Apart hotel y Boutique, menos de 200 plazas" }
knitr::include_graphics('imagenes/hoteles3_estrellas_apart_boutique_menos_200_plazas.jpg')
```

```{r 3-estrellas-mas200, echo=FALSE, fig.cap="Hoteles 3 estrellas,  Apart hotel y Boutique, más de 200 plazas" }
knitr::include_graphics('imagenes/hoteles3_estrellas_apart_boutique_mas_200_plazas.jpg')
```

```{r 4-5-estrellas-menos200, echo=FALSE, fig.cap="Hoteles 4 y 5 estrellas, menos de 200 plazas" }
knitr::include_graphics('imagenes/hoteles4_5_estrellas_menos_200_plazas.jpg')
```

```{r 4-5-estrellas-mas200, echo=FALSE, fig.cap="Hoteles 4 y 5 estrellas, más de 200 plazas" }
knitr::include_graphics('imagenes/hoteles4_5_estrellas_mas_200_plazas.jpg')
```

```{r para-hoteleros, echo=FALSE, fig.cap="Establecimientos parahoteleros" }
...
```{r total-localodad-y, echo=FALSE, fig.cap="Total localidad" }
