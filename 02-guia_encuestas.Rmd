...
knitr::include_graphics('imagenes/tabla_2.jpg')
```
...
knitr::include_graphics('imagenes/tabla_2A.jpg')
```

```{r peso_de_estrato, echo=FALSE, fig.cap="" }
knitr::include_graphics('imagenes/tabla_2B.jpg')
```
...
knitr::include_graphics('imagenes/tabla_2C.jpg')
```
...
knitr::include_graphics('imagenes/tabla_3.jpg')
```
...
knitr::include_graphics('imagenes/tabla_4.jpg')
```
...
knitr::include_graphics('imagenes/tabla_5.jpg')
```
...
knitr::include_graphics('imagenes/tabla_5a.jpg')
```
...
knitr::include_graphics('imagenes/tabla_6.jpg')
```
...
knitr::include_graphics('imagenes/tabla_6a.jpg')
```
...
Para afianzar las ideas desarrolladas en este apartado, a continuación se describirá el proceso de construcción de factores de expansión para las muestras seleccionadas en el apartado [Ejemplo de estratificación y selección de muestras al interior de cada estrato]

Recuérdese que la muestra final seleccionada fue:

```{r tabla_7a, echo=FALSE, fig.cap="Muestra final" }
knitr::include_graphics('imagenes/tabla_7a.jpg')
```
...
knitr::include_graphics('imagenes/tabla_7b.jpg')
```
...
knitr::include_graphics('imagenes/tabla_8.jpg')
```
...
```{r 1_2_estrellas, echo=FALSE, fig.cap="Hoteles 1 y 2 estrellas, menos de 200 plazas" }
knitr::include_graphics('imagenes/hoteles1y2_estrellas_menos_de_200_plazas.jpg')
```

```{r 3_estrellas, echo=FALSE, fig.cap="Hoteles 3 estrellas,  Apart hotel y Boutique, menos de 200 plazas" }
knitr::include_graphics('imagenes/hoteles3_estrellas_apart_boutique_menos_200_plazas.jpg')
```

```{r 3_estrellas_mas_200, echo=FALSE, fig.cap="Hoteles 3 estrellas,  Apart hotel y Boutique, más de 200 plazas" }
knitr::include_graphics('imagenes/hoteles3_estrellas_apart_boutique_mas_200_plazas.jpg')
```

```{r 4_5_estrellas_menos_200, echo=FALSE, fig.cap="Hoteles 4 y 5 estrellas, menos de 200 plazas" }
knitr::include_graphics('imagenes/hoteles4_5_estrellas_menos_200_plazas.jpg')
```

```{r 4_5_estrellas_mas_200, echo=FALSE, fig.cap="Hoteles 4 y 5 estrellas, más de 200 plazas" }
knitr::include_graphics('imagenes/hoteles4_5_estrellas_mas_200_plazas.jpg')
```

```{r para_hoteleros, echo=FALSE, fig.cap="Establecimientos parahoteleros" }
knitr::include_graphics('imagenes/establecimientos_parahoteleros.jpg')
```
...
knitr::include_graphics('imagenes/figuras_parte123_01.jpg')
```
